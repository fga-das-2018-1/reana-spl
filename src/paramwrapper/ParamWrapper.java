...
public class ParamWrapper implements ParametricModelChecker {
	...
	private String evaluate(String modelString, String property, ParamModel model) {
		try {
			...
			String formula = checkFormulaType(modelString, modelFile, propertyFile, resultsFile, model);
	...
	private String checkFormulaType(String modelString,File modelFile,File propertyFile, File resultsFile,ParamModel model) throws IOException {
		String formula = "";
